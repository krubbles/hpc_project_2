...
For most of your homework writeups, you are not expected to include a literature review of previous work. If this is not the case, you will be given explicit instructions to the contrary in the homework assignment writeup on Canvas.

In the event you do need to cite sources, an example would be to refer to Hennessey and Patterson, 2011~\cite{HennessyPatterson:CompArch5thEd:2011}.
